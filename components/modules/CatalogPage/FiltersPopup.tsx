...
const FiltersPopup = ({ resetFilterBtnDisabled, resetAllManufacturers, handleClosePopup, updateManufacturer, setManufacturer, applyFilters, openPopup, title, manufacturersList }: IFiltersPopupProps) => {
    ...
    return (
        <div className={`${styles.filters__popup} ${darkModeClass} ${openPopup ? styles.open : ''}`}>
            ...
            <div className={styles.filters__actions}>
                ...
                <button className={styles.filters__actions__reset} onClick={handleClosePopup}> Назад</button>
            </div>
        </div>
    );
}
